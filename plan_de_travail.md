...
- [x] **Optimisation Mobile & Mise en Page des Tarifs & Abonnements** : Refonte visuelle complète de la carte des tarifs (suppression des astérisques bruts `**`, alignement réactif en colonne `flex-col`, puces avec icône coche `✓` et badges haute lisibilité sur smartphones) ([OnboardingAuth.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/OnboardingAuth.tsx)).
