...
- [x] **Champ Email Obligatoire & Système de Validation de Compte par Email** : Obligation absolue de fournir une adresse e-mail unique lors de l'inscription pour tous les profils (Livreur, Boutique). Envoi automatique d'un e-mail de confirmation contenant un lien unique de validation (`/auth/verify-email?token=...`) et mise à jour du schéma PostgreSQL Supabase ([schema.prisma](file:///c:/Users/HP/Documents/Livraison/prisma/schema.prisma), [register/route.ts](file:///c:/Users/HP/Documents/Livraison/src/app/api/auth/register/route.ts), [verify-email/route.ts](file:///c:/Users/HP/Documents/Livraison/src/app/api/auth/verify-email/route.ts), [email.ts](file:///c:/Users/HP/Documents/Livraison/src/lib/email.ts), [OnboardingAuth.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/OnboardingAuth.tsx)).
