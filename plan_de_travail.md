...
- [x] **Masquage Strict du Code Secret Super Administrateur** : Remplacement du champ en champ mot de passe masqué (`type="password"`) et retrait de toute indication explicite ou d'exemple dans les placeholders (`Code Secret...`) pour garantir une confidentialité totale ([OnboardingAuth.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/OnboardingAuth.tsx), [Navbar.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/Navbar.tsx)).
