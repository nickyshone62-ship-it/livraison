...
- [x] **Accès Administrateur Discret & Instantané par le Logo (Code Secret Nick2004)** : Clic direct sur le logo `LivraisonOuaga` (depuis l'en-tête de la barre de navigation et sur la page d'inscription/connexion) ouvrant une fenêtre pop-up confidentielle exigeant le code maître (`Nick2004`) pour un accès immédiat à l'espace Administrateur ([Navbar.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/Navbar.tsx), [OnboardingAuth.tsx](file:///c:/Users/HP/Documents/Livraison/src/components/OnboardingAuth.tsx)).
