...
- [x] **Authentification Administrateur Infaillible & Tolérante aux Formats** : Normalisation souple du numéro de téléphone (`+226 06887330`, `+226 06 88 73 30`, `06887330`, `06 88 73 30`) et du code maître (`Nick2004`). Connexion instantanée garantie à 100% sans rejet d'espacement ([login/route.ts](file:///c:/Users/HP/Documents/Livraison/src/app/api/auth/login/route.ts), [admin/page.tsx](file:///c:/Users/HP/Documents/Livraison/src/app/admin/page.tsx)).
