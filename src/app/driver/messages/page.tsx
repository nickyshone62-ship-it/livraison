                      ...
                      >
                        <div className="relative">
                          <div className={`w-12 h-12 rounded-full p-0.5 shadow-sm transition-transform group-hover:scale-105 ${
                            ...
                            <div className="w-full h-full rounded-full bg-white flex items-center justify-center font-extrabold text-orange-600 text-sm overflow-hidden">
                              {p.avatarUrl ? (
              ...
              <>
                ...
                <div className="bg-white border border-slate-200/80 rounded-2xl p-3.5 mb-4 flex items-center justify-between shadow-sm">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="relative shrink-0">
                      <div className="w-10 h-10 rounded-2xl overflow-hidden bg-gradient-to-tr from-orange-500 to-amber-500 flex items-center justify-center font-black text-white text-sm shadow-sm">
