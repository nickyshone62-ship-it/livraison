...
export default function AdminClientsPage() {
  ...
  // Modal de Message Administrateur -> Client
  ...
  const handleSendAdminMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(data.message || 'Message envoyé avec succès au client !');
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white pb-16">
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-4 border-t border-slate-800 flex items-center justify-between gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => setMessageModalUser({ id: c.id, name: c.fullName || 'Client', phone: c.phone })}
                      className="py-2.5 px-3.5 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 font-bold text-xs flex items-center justify-center gap-1.5 border border-cyan-500/20 cursor-pointer"
                      title="Envoyer un message à ce client"
                    >
      ...
      {/* MODALE ENVOI DE MESSAGE AU CLIENT */}
      {messageModalUser && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="max-w-lg w-full bg-slate-900 border border-cyan-500/40 rounded-3xl p-6 shadow-2xl space-y-5">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-extrabold text-white text-base">Envoyer un Message au Client</h3>
            ...
            <form onSubmit={handleSendAdminMessage} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Écrivez le message destiné au client..."
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                >
                  ...
                  <span>{sendMessageLoading ? 'Envoi en cours...' : 'Envoyer au Client'}</span>
                </button>
              </div>
            </form>
          </div>
