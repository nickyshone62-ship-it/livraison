                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    <div className="flex justify-between items-center text-xs font-bold text-slate-700">
                      ...
                      <span className="text-amber-600 font-extrabold text-sm">{daysLeft} jour(s) et {hoursLeft} heure(s) restants</span>
                    </div>
                    ...
                    <div className="p-3 rounded-2xl bg-amber-50/70 border border-amber-200 text-[11px] text-amber-900 flex items-center gap-2 mt-3">
                      <Sparkles className="w-4 h-4 text-amber-600 shrink-0" />
                      <span><strong>Cumul garanti :</strong> Chaque réabonnement s'ajoute automatiquement à la suite de vos jours restants. Aucun jour n'est perdu !</span>
                    </div>
                  </div>
                </div>
              ) : pendingPayment ? (
