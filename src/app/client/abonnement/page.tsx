    ...
    <div className="min-h-screen bg-slate-950 text-white pb-12">
      <header className="border-b border-slate-800 bg-slate-900/60 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center space-x-4">
          ...
          <h1 className="text-xl font-bold text-white">Mon Abonnement Mensuel</h1>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        <div className="p-8 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900 to-amber-950/40 border border-slate-800 text-center space-y-4">
          <div className="w-16 h-16 rounded-2xl bg-amber-500/10 text-amber-400 flex items-center justify-center mx-auto">
            <CreditCard className="w-8 h-8" />
          </div>
          <h2 className="text-2xl font-black">Abonnement Client — 1 000 FCFA / mois</h2>
          <p className="text-slate-400 text-xs max-w-md mx-auto">
            Bénéficiez d'un accès illimité à la publication de demandes de livraison et à la mise en relation avec nos livreurs vérifiés.
          </p>
        </div>
        ...
        {success ? (
          <div className="p-6 rounded-3xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-center space-y-2">
            ...
            <p className="text-xs text-slate-300">Votre paiement de 1 000 FCFA est en cours de vérification par l'administration. Dès validation, votre abonnement sera actif 30 jours.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 rounded-3xl bg-slate-900 border border-slate-800 space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 text-xs space-y-2">
              <div className="font-bold text-amber-400">Paiement Mobile Money (1 000 FCFA) :</div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-slate-950 border border-slate-800 rounded-2xl text-white text-xs outline-none focus:ring-2 focus:ring-amber-500"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 text-white font-bold text-sm shadow-lg"
            >
